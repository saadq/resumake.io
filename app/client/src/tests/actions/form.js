...
test('form actions', async t => {
  ...
  t.deepEqual(clearJobDutyField(0, 1), { type: CLEAR_JOB_DUTY_FIELD, index: 0, jobDutyCount: 1 })
  t.deepEqual(clearProjectField(3), { type: CLEAR_PROJECT_FIELD, projectCount: 3 })
